...
def create_athena_partitions(database, table, s3_location, dates, levels):
    ...
    for date in dates:
        for level in levels:
            ...
            print(f"Partition query for date_partition={date} and level_partition={level} submitted. QueryExecutionId: {query_execution_id}")

if __name__ == "__main__":
    # Replace with your S3 bucket name and prefix
    bucket_name = 'csv-data-comp8157'
    prefix = ''

    # Replace with your Athena database, table, and S3 location
    athena_database = 'adt'
    athena_table = 'csv_table_with_partition'
    athena_s3_location = 's3://csv-data-comp8157'
